...
exports.get_logement_details = async (req, res) => {
  try {
    ...
    console.error(
      "Une erreur s'est produite lors de la récupération des détails du logement :",
      error
    );
    res
      .status(500)
...
exports.update_logement_details = async (req, res) => {
  try {
    ...
    logement = await Logement.findByIdAndUpdate(logement_id, req.body, {
      new: true,
    });
    ...
    // En cas d'erreur, renvoi d'un message d'erreur avec le code d'erreur 500 (Internal Server Error)
    console.error(
      "Une erreur s'est produite lors de la mise à jour des détails du logement :",
      error
    );
    res
      .status(500)
...
exports.update_all_logements = async (req, res) => {
  try {
    ...
    const updated_logements = await Logement.updateMany({}, req.body, {
      new: true,
    });
    ...
    // En cas d'erreur, renvoi d'un message d'erreur avec le code d'erreur 500 (Internal Server Error)
    console.error(
      "Une erreur s'est produite lors de la mise à jour des détails de tous les logements :",
      error
    );
    res
      .status(500)
...
exports.delete_logement = async (req, res) => {
  try {
    ...
    res
      ...
      .json({
        message:
          "Une erreur s'est produite lors de la suppression du logement.",
      });
  }
};
...
exports.delete_all_logements = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Tous les logements ont été supprimés avec succès." });
  } catch (error) {
    // En cas d'erreur, renvoi d'un message d'erreur avec le code d'erreur 500 (Internal Server Error)
    console.error(
      "Une erreur s'est produite lors de la suppression de tous les logements :",
      error
    );
    res
      .status(500)
...
exports.get_reservations_of_logement = async (req, res) => {
  try {
    ...
    if (!reservations || reservations.length === 0) {
      return res
        .status(404)
        .json({ message: "Aucune réservation trouvée pour ce logement." });
    }
    ...
    res
      ...
      .json({
        message:
          "Une erreur s'est produite lors de la récupération des réservations du logement.",
      });
  }
};
...
exports.get_all_logements = async (req, res) => {
  try {
    ...
    // En cas d'erreur, renvoi d'un message d'erreur avec le code d'erreur 500 (Internal Server Error)
    console.error(
      "Une erreur s'est produite lors de la récupération des logements :",
      error
    );
    res
      .status(500)
...
exports.search_logement = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        message: "Une erreur s'est produite lors de la recherche de logements.",
      });
  }
};
